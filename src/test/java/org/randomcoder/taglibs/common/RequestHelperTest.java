...
@SuppressWarnings("javadoc") public class RequestHelperTest extends TestCase {
  ...
  public void testParseParameters() throws Exception {
    ...
    Map<String, List<String>> params =
        RequestHelper.parseParameters(request, query);
  ...
  public void testParseParametersNullQuery() throws Exception {
    Map<String, List<String>> params =
        RequestHelper.parseParameters(request, null);
    assertNotNull(params);
    assertEquals(0, params.keySet().size());
  }
  ...
  public void testAppendParametersDuplicate() throws Exception {
    URL url =
        new URL("http://www.example.com/test?param1=test1&param2=test2orig");
    Map<String, String> additionalParams = new HashMap<String, String>();
  ...
  public void testGetCurrentUrl() throws Exception {
    ...
    String ext = result.toExternalForm();
    assertEquals(
        "http://www.example.com/test/servlet/index.jsp?param1=test1&param2=test2",
        ext);
  }
  ...
  public void testGetCurrentUrlForwardURI() throws Exception {
    ...
    request.setAttribute("javax.servlet.forward.request_uri",
        "/original/index.jsp");
    request
        .setAttribute("javax.servlet.forward.query_string", "?original1=test1");

    URL result = RequestHelper.getCurrentUrl(request);
    String ext = result.toExternalForm();
    assertEquals("http://www.example.com/original/index.jsp?original1=test1",
        ext);
