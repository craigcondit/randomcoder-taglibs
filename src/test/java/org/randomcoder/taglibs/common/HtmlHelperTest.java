...
@SuppressWarnings("javadoc") public class HtmlHelperTest extends TestCase {
  public void testEncodePCData() {
    String result =
        HtmlHelper.encodePCData("This has embedded < & > characters");
  ...
  public void testEncodeAttribute() {
    String result =
        HtmlHelper.encodeAttribute("This has embedded \" < & > characters");
    assertEquals("This has embedded &quot; &lt; &amp; &gt; characters", result);
