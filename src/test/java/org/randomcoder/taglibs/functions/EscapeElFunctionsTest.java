...
@SuppressWarnings("javadoc") public class EscapeElFunctionsTest
    extends TestCase {
  ...
  public void testUrlencodeNull() {
    assertEquals("Testing+%26+%3C+%3E",
        EscapeElFunctions.urlencode("Testing & < >"));
  }

  public void testAttribute() {
    assertEquals("Testing &amp; &lt; &gt; &#34; &#39;",
        EscapeElFunctions.attribute("Testing & < > \" '"));
  }
  ...
  public void testJsDouble() {
    assertEquals("Testing \\\\ \\\"",
        EscapeElFunctions.jsDouble("Testing \\ \""));
  }
  ...
  public void testJsSingle() {
    assertEquals("Testing \\\\ \\'",
        EscapeElFunctions.jsSingle("Testing \\ '"));
  }
