...
@SuppressWarnings("javadoc") public class CalendarTagTest
  ...
  public void testTag() throws Exception {
    ...
    // 31 days in january
    for (int i = 1; i <= 31; i++) {
      assertTrue(Integer.toString(i),
          result.contains("January " + i + ", 2000"));
    }
  ...
  public void testTagDefaultDay() throws Exception {
    tag.doStartTag();
    tag.setDaySpec(null,
        new CalendarDaySpec(true, "test.html", true, "testMonth", "testDay",
            "testYear", "testTitle", "testDayClass", null, null));
    tag.doAfterBody();
    tag.doEndTag();
    String result = writer.toString();
  ...
  public void testTagDaySpecified() throws Exception {
    tag.doStartTag();
    tag.setDaySpec(1,
        new CalendarDaySpec(false, null, null, null, null, null, null,
            "dayOneClass", "dayOneId", "one"));
    tag.doAfterBody();
    tag.doEndTag();
    String result = writer.toString();
  ...
  public void testTagInvalidSpecs() throws Exception {
    tag.doStartTag();
    tag.setDaySpec(-1,
        new CalendarDaySpec(null, null, null, null, null, null, null,
            "smallClass", null, null));
    tag.setDaySpec(32,
        new CalendarDaySpec(null, null, null, null, null, null, null,
            "bigClass", null, null));
    tag.doAfterBody();
  ...
  public void testTagEncodedDay() throws Exception {
    tag.doStartTag();
    tag.setDaySpec(1,
        new CalendarDaySpec(true, "index.html", true, "testMonth", "testDay",
            "testYear", "testTitle", "testClass", "testId", null));
    tag.doAfterBody();
    tag.doEndTag();
    String result = writer.toString();
  ...
  public void testTagConstantLink() throws Exception {
    tag.doStartTag();
    tag.setDaySpec(1,
        new CalendarDaySpec(true, "test.html?link=1/1/2000", false, null, null,
