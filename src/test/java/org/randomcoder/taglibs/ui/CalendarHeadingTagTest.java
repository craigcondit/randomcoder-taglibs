...
public class CalendarHeadingTagTest extends AbstractTagTestCase
{
	...
	public void testAbsoluteUrl() throws Exception
	{
		...
		assertTrue("prevLink", result.contains("href=\"http://test.com/prev.html?"));
		assertTrue("nextLink", result.contains("href=\"http://test.com/next.html?"));		
	}
